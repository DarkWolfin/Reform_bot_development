...
async def welcome(message: types.Message):
    ...
    await bot.send_message(message.from_user.id,
                           "\nНаш бот не в открытом доступе \nПожалуйста введите токен для доступа к боту!",
                           parse_mode='html')
...
async def main_menu(message: types.Message, state: FSMContext):
    ...
    await bot.send_message(message.from_user.id, 'Вы в главном меню. Не знаете что делать дальше?'
                                                        ...
                                                        '\n😨 Если вы знаете, что вас беспокоит, выберите "Тревожная кнопка", чтобы получить рекомендации по решению проблемы!'
                                                        '\n\n🧘‍♀️ Практики помогут вам разгрузиться после тяжёлого дня или успокоиться'
                                                        '\n📝 Пройдите тест, чтобы определить актуальное состояние и выявить проблему'
...
async def contacts(message: types.Message):
    await bot.send_message(message.from_user.id, 'Здравствуйте! '
                                                 ...
                                                 '\n\nЕсли у вас есть вопросы или вы обнаружили ошибку, вы можете обратиться к команде разработчиков напрямую, нажав на кнопку "Техподдержка" в главном меню!',
...
async def reply_all(message: types.Message, state: FSMContext):
    ...
    if message.text == '🌳 Самоанализ':
        await bot.send_message(message.from_user.id, text='Как вы себя чувствуете?', parse_mode='html', reply_markup=Markups.start_helpsystem)
        await FSM_classes.HelpSystem.start.set()
        await log_users(message)
    ...
    if message.text == '😨 Тревожная кнопка':
        await FSM_classes.MultiDialog.quick_help.set()
        await bot.send_message(message.from_user.id,
                               text='Выберите, что вы чувствуете, чтобы разобраться в проблеме и понять, как её решить',
    ...
    if message.text == 'Что ты умеешь?':
        ...
        await bot.send_message(message.from_user.id,
                               ...
                               '\n\nВыберите в меню "Самоанализ", если хотите разобраться в себе и ввыяснить причину самочувствия!'
                               '\nЕсли вы знаете проблему, выберите "Тревожная кнопка", чтобы получить рекомендации по её решению!'
                               '\n\nВыберите раздел "Практики", если хотите разгрузиться или чувствуете себя не важно. '
                               '\nТакже, если вы не знаете в чём проблема, но чувствуете себя не очень, то можете пройти тесты (раздел "Тесты") и лучше понять себя.'
                               '\nВ разделе "Привычки" вы можете получить полезные привычки и поддержать навыки.'
